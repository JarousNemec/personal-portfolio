...
const AboutSection: React.FC = () => {
    ...
    return (
        <Section id={"about"} title={"O mně"} containerClassName={styles.about}
                 containerAriaLabel={"Základní informace o mně"}>
            <p className={styles.bio}>
                Jmenuji se Jaroslav Němec a už několik let se věnuji vývoji software a práci s moderními technologiemi.
                Aktuálně studuji obor Aplikovaná informatika na Univerzitě Hradec Králové. Zaměřuji se především na
                vývoj webových aplikací a mým cílem je stát se kvalitním full-stack vývojářem.
                ...
                {/*stránce.*/}
                {/*<div className={`${styles.hiddenContent} ${expanded ? styles.show : ""}`}>*/}
                {/*    <br/>*/}
