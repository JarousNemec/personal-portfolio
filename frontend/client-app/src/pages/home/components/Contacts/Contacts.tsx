      ...
      <div className="container">
        <div className="contact-card" role="region" aria-label="Kontaktní informace">
          ...
          <div className="contact-links">
            ...
            <a href="https://github.com/JarousNemec" target="_blank" rel="noopener noreferrer" className="contact-btn github">
              {/* GitHub icon */}
            ...
            <a href="https://www.linkedin.com/in/jaroslav-n%C4%9Bmec-800a17252/" target="_blank" rel="noopener noreferrer" className="contact-btn linkedin">
              {/* LinkedIn icon */}
              <svg fill="currentColor" viewBox="0 0 24 24">
