    ...
    return (
        <Section id={"about"} title={"O mně"} containerClassName={styles.about}
            ...
            <p className={styles.bio}>
                Jmenuji se Jaroslav Němec a už několik let se věnuji vývoji software a práci se zajímavými technologiemi.
                Aktuálně studuji obor Aplikovaná informatika na Univerzitě Hradec Králové. Zaměřuji se na
                vývoj webových i desktopových aplikací a mým cílem je stát se kvalitním full-stack vývojářem jak po teoretické tak i praktické stránce.
                <br/><br/>
